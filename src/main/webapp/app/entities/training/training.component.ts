  ...
  trainings?: ITraining[] = [
    {
      ...
      date: '29-june-2021',
      typeOfSport: 'Running',
      trainingDurationHour: 1,
      trainingDurationMin: 50,
      intensity: 'Low',
      temperature: 10,
      weightBeforeTraining: '97, 0',
      weightAfterTraining: '97, 0',
      fluidDrunkL: 1,
      fluidDrunkMl: 50,
      eatenInTrainingKg: 1,
      eatenInTrainingGr: 100,
